...
const CountryContainer: Component = () => {
  ...
  return (
    <div>
      {query.isLoading && <progress class="progress progress-info w-full" />}
          ...
          {(country: Country) => (
            <div class="w-84 card card-compact bg-base-100 shadow-xl transition duration-300 ease-in-out hover:scale-105 hover:shadow-lg">
              ...
              <div class="card-body">
                ...
                <p class="font-nunito-sans text-lg text-info">{country.population.toLocaleString()}</p>
                <div class="card-actions justify-end">
                  <button type="button" class="btn-neutral btn font-nunito-sans uppercase text-700">
                    Details
                  </button>
                </div>
              </div>
